...
function Helpful(baseReporterDecorator, formatError, config) {
  ...
  self.options.animationStyle ? drawUtil.setAnimationStyle(self.options.animationStyle) : undefined;
  self.options.clearScreenBeforeEveryRun ? dataTypes.clearScreenBeforeEveryRun() : undefined;
  self.options.hideBrowser ? dataTypes.hideBrowser() : undefined;
  self.options.maxLogLines ? dataTypes.setMaxLogLines(self.options.maxLogLines) : undefined;
  self.options.removeLinesContaining ? dataTypes.setLinesToExclude(self.options.removeLinesContaining) : undefined;
  self.options.removeTail ? dataTypes.removeTail() : undefined;
  self.options.suppressErrorHighlighting ? dataTypes.suppressErrorHighlighting() : undefined;
  self.options.underlineFileType ? dataTypes.setFileTypeToUnderline(self.options.underlineFileType): undefined;
